...
data_directory = "C:/Users/BIPIN/Desktop/nair/" #insert the directory you'll be working with
img_size = 128
...
#print(X)
hf = h5py.File("C:/Users/BIPIN/Desktop/nair/concrete_crack_image_data.h5", "w") #Replace the three dots with the directory you want to save your dataset in
